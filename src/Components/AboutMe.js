...
const AboutMe = () => {
    return (
        <section class="about-me" id="about">
            ...
            <img src='https://images.unsplash.com/photo-1534030347209-467a5b0ad3e6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1' alt="" class="about-me__img" />
        </section>
    );
};
